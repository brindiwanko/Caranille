        ...
        && $_POST['adminMonsterId'] >= 1)
        {
            ...
            if ($monsterRow == 1) 
            {
                ...
                <form method="POST" action="editMonster.php">
                    ...
                    <input type="submit" class="btn btn-secondary btn-lg" name="edit" value="Afficher/Modifier le monstre">
                </form>
                <form method="POST" action="../monstersDrops/manageMonsterDrop.php">
                    ...
                    <input type="hidden" class="btn btn-secondary btn-lg" name="token" value="<?php echo $_SESSION['token'] ?>">
                    <input type="submit" class="btn btn-secondary btn-lg" name="manage" value="Objet(s) du monstre">
                </form>
                <form method="POST" action="../monstersBattlesStats/manageMonsterStatsLight.php">
                    ...
                    <input type="hidden" class="btn btn-secondary btn-lg" name="token" value="<?php echo $_SESSION['token'] ?>">
                    <input type="submit" class="btn btn-secondary btn-lg" name="viewStats" value="Statistiques de combat">
                </form>
